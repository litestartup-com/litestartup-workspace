...
> Lite Email for Startups to Launch & Grow Faster. Includes Workmail, Marketing, Transactional Emails, AI-Powered Tools.

## Overview

This document is a quick start guide for LiteStartup.

## Contents

- **[Introduction](index.md)** - Learn what LiteStartup is and why you should use it
- **[Quickstart](quickstart.md)** - Sign up and send your first email in 5 minutes
- **[Pricing & Plans](pricing.md)** - Understand pricing and billing
- **[Features Guide](features/index.md)** - Explore all features in detail
...
- [Dashboard](https://app.litestartup.com/home)
...
### AI Website Builder
Chat with AI to create landing pages, waitlist pages, newsletters, blogs, and documents. No coding needed.
...
- **Freelancers** who need to send emails to clients
- **Small businesses** that need to send emails to customers
...
- 💬 Chat with us on [LiteStartup.com](https://www.litestartup.com) for support
- 📧 Contact: support@litestartup.com
